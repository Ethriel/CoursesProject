...
namespace Infrastructure.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SystemUsersTrainingCourses",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SystemUsersTrainingCourses", x => new { x.SystemUserId, x.TrainingCourseId });
                    table.ForeignKey(
                        name: "FK_SystemUsersTrainingCourses_AspNetUsers_SystemUserId",
                        column: x => x.SystemUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SystemUsersTrainingCourses_TrainingCourses_TrainingCourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemUsersTrainingCourses_TrainingCourseId",
